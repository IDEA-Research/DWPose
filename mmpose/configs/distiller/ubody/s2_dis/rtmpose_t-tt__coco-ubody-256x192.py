_base_ = ['../../../wholebody_2d_keypoint/rtmpose/ubody/rtmpose-t_8xb64-270e_coco-ubody-wholebody-256x192.py']
...
model = dict(
    ...
    two_dis = second_dis,
    teacher_pretrained = 'work_dirs/rtmpose_l_dis_t__coco-ubody-256x192/dw-l-t_ucoco.pth',
