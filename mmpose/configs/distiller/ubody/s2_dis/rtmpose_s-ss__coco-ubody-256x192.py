...
model = dict(
    ...
    two_dis = second_dis,
    teacher_pretrained = 'work_dirs/rtmpose_l_dis_s__coco-ubody-256x192/dw-l-s_ucoco.pth',
    teacher_cfg = 'configs/wholebody_2d_keypoint/rtmpose/ubody/rtmpose-s_8xb64-270e_coco-ubody-wholebody-256x192.py',
